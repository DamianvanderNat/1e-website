        ...
        <form action="#">
            <div class="bank">
                ...
                <select name="Bank" id="bank">
                    ...
                    <option value="Van Lanschot Kempen">Van Lanschot Kempen</option>
                    <option value="Yoursafe">Yoursafe</option>
                </select>
            </div>
            <div class="country">
                <label for="country">Country</label><br>
                <select name="Select your country" id="country">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (isset($_POST['user']) && isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['postalcode'])) {
                    $user = $_POST['user'];
                    $fname = $_POST['fname'];
                    $lname = $_POST['lname'];
                    $postalcode = $_POST['postalcode'];
                    $sql = "INSERT INTO `orders` (`user`, `fname`, `lname`, `postalcode`) VALUES ('$user', '$fname', '$lname','$postalcode' )";
